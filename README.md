...
| **김동현 (팀원)** | 하드웨어 제작 및 테스트 | <ul><li>센서·부저·팬 배선 및 하드웨어 조립</li><li>LCD·팬·부저 구동 테스트</li><li>Wi-Fi 및 Bluetooth 모듈 설정</li><li>관리자용 STM32 펌웨어 제작 및 시리얼 통신 테스트</li></ul> |
...
“Shhh(쉿!)” 시스템은  
원룸이나 고시원 등 **공유 주거 공간의 소음, 진동, 화재, 유해가스 등을 감지**하고  
