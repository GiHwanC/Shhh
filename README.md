...
“Shhh(쉿!)” 시스템은
원룸이나 고시원 등 **공유 주거 공간에서 발생하는 소음·진동·화재·가스 문제를 실시간으로 감지**하고,
...
* 원룸 생활 중, **옆방의 전화·음악·진동 등으로 수면 방해**를 받는 일이 잦음
* 직접 항의하거나 신고하기 어려운 환경 → **관리자 중재 의존**
* 불꽃·가스 누출 등의 **안전사고도 초기에 파악 어려움**
* 집주인·관리자 입장에서 **원격 모니터링과 자동 알림 시스템**의 필요성 인식
